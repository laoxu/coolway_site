...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","touppercase","tolowercase","Indent","RemoveFormat","FormatMatch","AutoTypeSet","PastePlain","RowSpacingTop","LineHeight","FontFamily","ImageCenter","ImageRight","ImageLeft","ImageNone","FontSize","PageBreak","InsertImage","scrawl","SnapScreen","Emotion","InsertVideo","Attachment","InsertFrame","Date","Map","Horizontal","Anchor","Spechars","BlockQuote","HighlightCode","template","background","Source","Undo","Redo","InsertUnorderedList","InsertOrderedList","Link","Unlink","ClearDoc","SearchReplace","Preview","|","SelectAll","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','touppercase':'','tolowercase':'','indent':'','removeformat':'','formatmatch':'','autotypeset':'','pasteplain':'','rowspacingtop':'','lineheight':'','fontfamily':'','imagecenter':'','imageright':'','imageleft':'','imagenone':'','fontsize':'','pagebreak':'','insertimage':'','scrawl':'','snapscreen':'','emotion':'','insertvideo':'','attachment':'','insertframe':'','date':'','map':'','horizontal':'','anchor':'','spechars':'','blockquote':'','highlightcode':'','template':'','background':'','source':'','undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','link':'','unlink':'','cleardoc':'','searchreplace':'','preview':'','|':'','selectall':'','inserttable':'','deletetable':'','mergeright':'','mergedown':'','splittorows':'','splittocols':'','splittocells':'','mergecells':''}
